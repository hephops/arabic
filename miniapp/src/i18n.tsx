...
const UZ: Record<string, string> = {
  ...
  scanVibeNone: "Bu qurilma titrashni qo'llab-quvvatlamaydi (iPhone'da bunday imkoniyat yo'q)",
...
const RU: Record<string, string> = {
  ...
  scanVibeNone: 'Это устройство не поддерживает вибрацию (на iPhone такой возможности нет)',
